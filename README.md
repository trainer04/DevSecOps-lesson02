...
- Install Cosign locally (the only purpose - to use the tool for pub/private key pair generation):<br>
...
- Also add the <b>"Docker Pipeline"</b> and <b>"Pipeline Utility Steps"</b> plugins<br>
